package com.opencryptotrade.cryptocurrencyservice.util;
...
public class LoggingReactorMessageDispatchInterceptor<M extends Message<?>>
    ...
    public Mono<M> intercept(Mono<M> monoMessage) {
        return monoMessage.doOnNext(message -> LOGGER.info("Dispatched message: [{}]", message.getPayloadType().getSimpleName()));
    }
}
